 ...
 *
 * $info is an array which contains code coverage data. It is composed of sub-arrays, one for each method executed.
 * Each of these sub-arrays contains two further sub-arrays - 'branches' and 'paths'.
 * 'branches' contains metadata about all the executable statements in that method.
 * 'paths' contains an array of IDs, which map to the array indices of the 'branches' array.
 * These IDs are the statements that actually CAN be executed - they represent 'paths' through the code.
 * The path that was ACTUALLY executed is indicated by the presence of the array key 'hit' with a value of '1'.
 *
 * @param array[] $info
 *
 * @return string
